...
class DiscrepancyReport(Base):
    ...
    # Rule engine
    rules_triggered = Column(JSONB, nullable=True)
    rule_label      = Column(String(64), nullable=True)
    ...
    consensus     = Column(String(8), nullable=True)

    # 27-Parameter clinical checklist
    ...
    # Pharmacist feedback
    pharmacist_label = Column(String(64), nullable=True)
